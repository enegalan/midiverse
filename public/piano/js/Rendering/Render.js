...
export class Render {
	...
	getBgCanvas() {
		if (!this.cnvBG) {
			...
			document.querySelector('#midiverse-piano')?.appendChild(this.cnvBG)
	...
	getMainCanvas() {
		if (!this.cnv) {
			...
			document.querySelector('#midiverse-piano')?.appendChild(this.cnv)
	...
	getForegroundCanvas() {
		if (!this.cnvForeground) {
			...
			document.querySelector('#midiverse-piano')?.appendChild(this.cnvForeground)
	...
	getProgressBarCanvas() {
		if (!this.progressBarCanvas) {
			...
			document.querySelector('#midiverse-piano')?.appendChild(this.progressBarCanvas)
