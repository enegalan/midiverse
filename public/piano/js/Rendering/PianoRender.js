...
export class PianoRender {
	...
	getPianoCanvasWhite() {
		if (!this.pianoCanvasWhite) {
			...
			document.querySelector('#midiverse-piano')?.appendChild(this.pianoCanvasWhite)
	...
	getPlayedKeysWhite() {
		if (!this.playedKeysCanvasWhite) {
			...
			document.querySelector('#midiverse-piano')?.appendChild(this.playedKeysCanvasWhite)
	...
	getPianoCanvasBlack() {
		if (!this.pianoCanvasBlack) {
			...
			document.querySelector('#midiverse-piano')?.appendChild(this.pianoCanvasBlack)
	...
	getPlayedKeysBlack() {
		if (!this.playedKeysCanvasBlack) {
			...
			document.querySelector('#midiverse-piano')?.appendChild(this.playedKeysCanvasBlack)
