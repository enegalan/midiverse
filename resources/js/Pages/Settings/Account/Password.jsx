                    ...
                    <div className='h-screen'>
                        ...
                        <div className='px-5 mt-12'>
                            <div className='flex flex-col gap-7 my-2'>
                                <div>
                                    <FloatLabelInput disabled={user['auth_type'] == 'google'} type='password' className={`w-full ${user['auth_type'] == 'google' && 'bg-[var(--light-grey)] pointer-events-none'}`} id='current-password' text='Current password' value={currentPassword} onChange={onCurrentPasswordChange} />
                                ...
                                <div className='mt-2'>
                                    <FloatLabelInput disabled={user['auth_type'] == 'google'} type='password' className={`w-full ${user['auth_type'] == 'google' && 'bg-[var(--light-grey)] pointer-events-none'}`} id='password-change' text='New password' value={newPassword} onChange={onNewPasswordChange} />
                                    {passwordVerifyError && <div className="text-red-500">{passwordVerifyError}</div>}
                                </div>
                                <div className='mt-2'>
                                    <FloatLabelInput disabled={user['auth_type'] == 'google'} type='password' className={`w-full ${user['auth_type'] == 'google' && 'bg-[var(--light-grey)] pointer-events-none'}`} id='password-verify-change' text='Verify password' value={passwordVerify} onChange={onPasswordVerifyChange} />
                                    {passwordVerifyError && <div className="text-red-500">{passwordVerifyError}</div>}
                                </div>
                                <div>
