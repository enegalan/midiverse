            ...
            <div className='flex flex-col w-full gap-6'>
                <div className='flex gap-5'>
                    ...
                    <>
                        ...
                        <div className='flex flex-col items-start'>
                            <Link href={`/g/${group.name}`} className='whitespace-nowrap overflow-hidden overflow-ellipsis max-w-[160px] font-bold hover:underline hover:cursor-pointer'>{group.name}</Link>
                        </div>
                    </>
                    )}
                </div>
